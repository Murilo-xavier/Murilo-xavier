# 👋 Olá, eu sou Murilo Xavier

🎓 Estudante de **Ciência da Computação**  
💻 Foco em desenvolvimento de software, lógica e resolução de problemas  
📍 Paraíba, Brasil

> _"Sempre em busca de evolução através do aprendizado contínuo."_

---

## 🚀 Sobre mim

Sou estudante de **Ciência da Computação**, com grande interesse por tecnologia, desenvolvimento de software e resolução lógica de problemas.  
Aqui no meu GitHub, compartilho projetos relacionados à minha jornada acadêmica, incluindo **estruturas de dados, algoritmos, desenvolvimento de sistemas e lógica de programação**.

Estou em constante busca por evolução técnica e pessoal, utilizando este espaço como um registro do meu aprendizado e crescimento na área de tecnologia.

---

## 🌟 Soft Skills em desenvolvimento

Além dos conhecimentos técnicos, valorizo e desenvolvo continuamente habilidades interpessoais essenciais, como:
...
Essas qualidades contribuem diretamente para meu crescimento **acadêmico e profissional**.
...
---
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/murilo-xavier/murilo-xavier/output/pacman-contribution-graph-dark.svg">
